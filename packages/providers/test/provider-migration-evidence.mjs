...
export async function runErrorMigrationEvidence({
  ...
  const observedAssemblyClose = await recordFactoryCall(
    "packages/providers/src/assemblyai-stt.ts:691:10:providerError",
    "providerError",
  ...
  const checkedAssemblyClose = await assertErrorMigrationEvidence({
    sourceLocation: "packages/providers/src/assemblyai-stt.ts:691:10:providerError",
  ...
  const observedAssemblyProtocol = await recordFactoryCall(
    "packages/providers/src/assemblyai-stt.ts:725:10:providerError",
    "providerError",
  ...
  const checkedAssemblyProtocol = await assertErrorMigrationEvidence({
    sourceLocation: "packages/providers/src/assemblyai-stt.ts:725:10:providerError",
    factory: "providerError",
  ...
  const observedDeepgramClose = await recordFactoryCall(
    "packages/providers/src/deepgram.ts:616:10:providerError",
    "providerError",
  ...
  const checkedDeepgramClose = await assertErrorMigrationEvidence({
    sourceLocation: "packages/providers/src/deepgram.ts:616:10:providerError",
    factory: "providerError",
  ...
  const observedDeepgramProtocol = await recordFactoryCall(
    "packages/providers/src/deepgram.ts:639:10:providerError",
    "providerError",
  ...
  const checkedDeepgramProtocol = await assertErrorMigrationEvidence({
    sourceLocation: "packages/providers/src/deepgram.ts:639:10:providerError",
    factory: "providerError",
  ...
  const observedElevenClose = await recordFactoryCall(
    "packages/providers/src/elevenlabs-stt.ts:432:10:providerError",
    "providerError",
  ...
  const checkedElevenClose = await assertErrorMigrationEvidence({
    sourceLocation: "packages/providers/src/elevenlabs-stt.ts:432:10:providerError",
    factory: "providerError",
  ...
  const observedElevenProtocol = await recordFactoryCall(
    "packages/providers/src/elevenlabs-stt.ts:463:10:providerError",
    "providerError",
  ...
  const checkedElevenProtocol = await assertErrorMigrationEvidence({
    sourceLocation: "packages/providers/src/elevenlabs-stt.ts:463:10:providerError",
    factory: "providerError",
  ...
  const observedSarvam = await recordFactoryCall(
    "packages/providers/src/sarvam.ts:461:10:providerError",
    "providerError",
  ...
  const checkedSarvam = await assertErrorMigrationEvidence({
    sourceLocation: "packages/providers/src/sarvam.ts:461:10:providerError",
    factory: "providerError",
  ...
  const observedSonioxClose = await recordFactoryCall(
    "packages/providers/src/soniox-stt.ts:677:10:providerError",
    "providerError",
  ...
  const checkedSonioxClose = await assertErrorMigrationEvidence({
    sourceLocation: "packages/providers/src/soniox-stt.ts:677:10:providerError",
    factory: "providerError",
  ...
  const observedSonioxProtocol = await recordFactoryCall(
    "packages/providers/src/soniox-stt.ts:711:10:providerError",
    "providerError",
  ...
  const checkedSonioxProtocol = await assertErrorMigrationEvidence({
    sourceLocation: "packages/providers/src/soniox-stt.ts:711:10:providerError",
    factory: "providerError",
