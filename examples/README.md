...
| [TTS failover](./tts-failover/README.md)                       | Application-owned Sarvam → ElevenLabs TTS fallback | Sarvam, ElevenLabs, Deepgram, and Groq                       |
...
- Use **TTS failover** to see provider selection and fallback kept in application code.
